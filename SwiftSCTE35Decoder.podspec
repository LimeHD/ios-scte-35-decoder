...
Pod::Spec.new do |spec|
  ...
  spec.author             = 'Robert Galluccio'
  # Or just: spec.author    = 'Algashev Alexander'
  # spec.authors            = { 'Algashev Alexander' => 'algashev@mail.ru' }
  # spec.social_media_url   = 'https://twitter.com/Algashev Alexander'
